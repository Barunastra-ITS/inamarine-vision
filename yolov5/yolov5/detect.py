...
class Detect(Node):
    def __init__(self):
        ...
        self.weights = '/home/ikhw/inamarine_vision_gesture/build/yolov5/build/lib/yolov5/trained/yolov5n_adam/yolov5n_adam_openvino_model/' 
        self.data = '/home/ikhw/inamarine_vision_gesture/build/yolov5/build/lib/yolov5/trained/yolov5n_adam/yolov5n_adam_openvino_model/yolov5n_adam.yaml'

        self.source = 0#'/home/ikhw/Downloads/ball_resized.mp4' # 0 for webcam, path to video file, or image folder
        ...
        self.svm_load = False # load SVM model for buoy color detection
        self.svm_size = (24, 24) # SVM model image size
    ...
    def getBuoyColor(self, img, x_min, y_min, x_max, y_max):
        ...
        prediction_color = self.clf.predict([flattened_img])
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if label == 'ball':
                            if not self.svm_load:
                                filename = '/home/ikhw/inamarine_vision_gesture/build/yolov5/build/lib/yolov5/trained/color_model/ball_model.pkl'
